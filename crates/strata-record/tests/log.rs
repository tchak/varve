use strata_core::canonical::Salt;
use strata_core::primitives::Instant;
use strata_core::{ColumnId, GroupId, ItemId, PathSeg, ResolverId, RevisionId, RowPath};
use strata_record::{
...
use strata_value::{CellAddr, CellState, CellValue, Op, Scalar};
...
fn derivation() -> Derivation {
    Derivation {
        ...
        source_version: 1,
        mapping_version: 1,
        snapshot_ref: strata_record::genesis_hash(),
    }
}
